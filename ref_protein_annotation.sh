...
python $DIR/python_scripts/VCF_converter_reference.py vcf_map_reference -i $output_folder -o $output_folder_final
echo 'VCF file created for reference process'

echo 'calculating Amino acid mutations'
python $DIR/python_scripts/Reference_AA_mapping.py aa_map_reference -i $output_folder -o $output_folder_final
...
python $DIR/python_scripts/Reference_EC_mapping.py ec_map -i $output_folder -o $output_folder_final

python $DIR/python_scripts/Reference_GO_mapping.py go_map -i $output_folder -o $output_folder_final
