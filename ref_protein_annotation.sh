...
echo " $DIR/python_scripts/Reference_EC_species_summary.py ec_species_map -i $output_folder_final       "
python $DIR/python_scripts/Reference_GO_species_summary.py go_species_map -i $output_folder_final
echo " $DIR/python_scripts/Reference_GO_species_summary.py go_species_map -i $output_folder_final    "
