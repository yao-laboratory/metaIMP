...
| Table 2       | Assembly_mapping_result_non_coding.csv  | Reference_mapping_result_non_cds_gene.csv      | Assembly: Non-coding level information 
Reference: Non-CDS gene information |
