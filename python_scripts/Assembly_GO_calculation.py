...
def assembly_go_calculation(eggnog_file, scaffold_file, step_5_mapping_result, path_of_the_directory, instrain_snvs, coverage_file, output):
...
def main():
    ...
    assembly_go_parser.add_argument("-c",dest="coverage_file",type=str,help="coverage file generated by BBMap")
    ...
    if args.subcommand=='go_map':
        ...
        assembly_go_calculation(eggnog_file, scaffold_file, step_5_mapping_result, path_of_the_directory, instrain_snvs, coverage_file, output)
