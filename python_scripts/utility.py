...
# Edited code base by Kalyan Sahu, Dr. Qiuming Yao, YAOLAB, School of Computing, University of Nebraska-Lincoln
...
def add_executables(args):
	...
	process.wait()
        ...
        #edited if condition- removed not null parameter - K.Sahu
